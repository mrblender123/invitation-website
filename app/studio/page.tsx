...
function StudioContent() {
  ...
  const handleGoToExport = () => {
    localStorage.setItem('shareyoursimcha-state', JSON.stringify({ data, ...settings, canvasWidth: canvasSize.width, canvasHeight: canvasSize.height }));
    router.push('/export');
  };
    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100vh', background: '#09090b', fontFamily: 'var(--font-inter), system-ui, sans-serif' }}>
      ...
      <header style={{
        ...
        <Link href="/" style={{ textDecoration: 'none', display: 'flex', alignItems: 'center' }}>
          <img src="/logo.svg" alt="Share Your Simcha" style={{ height: 32, width: 'auto', filter: 'brightness(0) invert(1)' }} />
        </Link>
