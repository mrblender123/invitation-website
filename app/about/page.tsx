...
export default function AboutPage() {
  return (
    <div style={{ minHeight: '100vh', background: '#09090b', color: '#fff', fontFamily: 'var(--font-inter), system-ui, sans-serif', position: 'relative', overflow: 'hidden' }}>

      {/* Ambient orbs */}
      <div aria-hidden="true" style={{ position: 'absolute', top: '-10%', left: '-12%', width: 600, height: 600, borderRadius: '50%', background: 'radial-gradient(circle, rgba(255,255,255,0.08) 0%, transparent 70%)', filter: 'blur(60px)', pointerEvents: 'none', zIndex: 0 }} />
      <div aria-hidden="true" style={{ position: 'absolute', top: '-8%', right: '-14%', width: 550, height: 550, borderRadius: '50%', background: 'radial-gradient(circle, rgba(255,255,255,0.06) 0%, transparent 70%)', filter: 'blur(70px)', pointerEvents: 'none', zIndex: 0 }} />
      ...
      <section style={{ maxWidth: 720, margin: '0 auto', padding: '100px 24px 80px', textAlign: 'center', position: 'relative', zIndex: 1 }}>
        ...
        <h1 style={{ fontFamily: 'var(--font-playfair)', fontSize: 'clamp(36px, 6vw, 64px)', fontWeight: 700, letterSpacing: '-0.03em', lineHeight: 1.1, margin: '0 0 28px' }}>
          Simple.{' '}
          <span style={{ color: 'rgba(255,255,255,0.35)' }}>Easy.</span>{' '}
          Done.
        </h1>
      ...
      <section style={{ maxWidth: 900, margin: '0 auto', padding: '0 24px 100px', position: 'relative', zIndex: 1 }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
          {STEPS.map((step, i) => (
            ...
            >
              <div style={{ fontFamily: 'var(--font-playfair)', fontSize: 48, fontWeight: 700, color: 'rgba(255,255,255,0.08)', lineHeight: 1, paddingTop: 4 }}>
                {step.number}
              </div>
              <div>
                <h2 style={{ fontFamily: 'var(--font-playfair)', fontSize: 28, fontWeight: 700, letterSpacing: '-0.02em', margin: '0 0 12px', color: '#fff' }}>
                  {step.title}
                </h2>
                <p style={{ fontSize: 16, lineHeight: 1.75, color: 'rgba(255,255,255,0.45)', margin: 0 }}>
                  {step.body}
                </p>
              </div>
            </div>
      ...
      <section style={{ maxWidth: 640, margin: '0 auto', padding: '0 24px 120px', textAlign: 'center', position: 'relative', zIndex: 1 }}>
        <div style={{ width: 1, height: 60, background: 'linear-gradient(to bottom, transparent, rgba(255,255,255,0.15), transparent)', margin: '0 auto 60px' }} />
        <p style={{ fontSize: 20, lineHeight: 1.8, color: 'rgba(255,255,255,0.5)', fontStyle: 'italic' }}>
      ...
      <section style={{ maxWidth: 760, margin: '0 auto', padding: '0 24px 100px', position: 'relative', zIndex: 1 }}>
        <p style={{ fontSize: 12, fontWeight: 600, letterSpacing: '0.14em', color: 'rgba(255,255,255,0.3)', textTransform: 'uppercase', marginBottom: 16, textAlign: 'center' }}>
          FAQ
        </p>
        <h2 style={{ fontFamily: 'var(--font-playfair)', fontSize: 'clamp(24px, 3.5vw, 36px)', fontWeight: 700, letterSpacing: '-0.02em', textAlign: 'center', marginBottom: 40, color: '#fff' }}>
          Common questions
        </h2>
        <FaqAccordion />
      </section>
      ...
      <section style={{ padding: '0 24px 120px', position: 'relative', zIndex: 1 }}>
        <div style={{
          ...
          <h2 style={{ fontFamily: 'var(--font-playfair)', fontSize: 'clamp(24px, 3.5vw, 36px)', fontWeight: 700, letterSpacing: '-0.02em', marginBottom: 16, color: '#fff' }}>
