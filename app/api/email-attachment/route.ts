  ...
  try {
    const { error: sendError } = await resend.emails.send({
      ...
      html: `<div style="font-family:system-ui,sans-serif;max-width:520px;margin:0 auto;padding:40px 24px;color:#1a1a1a;font-size:15px;line-height:1.6;">
        ...
        <p style="margin:0 0 16px;">Your invitation is attached to this email as a PNG and PDF.</p>
        <p style="margin:0 0 16px;">You can edit and re-download up to 3 times within 7 days:<br><a href="${downloadUrl}" style="color:#0f172a;">${downloadUrl}</a></p>
